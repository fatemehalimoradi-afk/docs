...
1. Knit is installed from [https://apps.shopify.com/knit-bundles](https://apps.shopify.com/knit-bundles) and has been **opened once** in Shopify admin.
...
1. Confirm the Knit automatic discount is **Active** in Shopify admin → **Discounts**.
2. Confirm the bundle is **Active**.
3. Add a bundle from the widget, then open the test order in **Orders**. Each bundle line should show `__FB_ATC_UID` and the discount.
...
| Tapcart | The Knit block adds the property. No extra merchant step. |
